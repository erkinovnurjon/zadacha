...
const Hero = () => {
  return (
        <section className="dark:text-gray-400 dark:bg-gray-900 py-24 bg-white text-black body-font">
              <div className="container mx-auto flex px-5  md:flex-row flex-col items-center">
                    ...
                    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                          <Image className="object-cover object-center rounded" alt="hero" src="https://dummyimage.com/720x600" width={720} height={360} />
                    </div>
              </div>
        </section>
  )
